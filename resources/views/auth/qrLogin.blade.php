...
<div class="container" id="QR-Code">
            ...
            <div class="col-md-6">
                <div class="well" style="position: relative;display: inline-block;">
                    <canvas width="820" height="540" id="webcodecam-canvas"></canvas>
            ...
            <div class="col-md-6">
                ...
                <div class="thumbnail" id="result">
                    ...
                    <div class="caption">
                        <h3 style="color: black" id="first_name"></h3>
                        <h3 style="color: black" id="first_nam"></h3>
                        <h6 style="color: black" id="scanned-QR"></h6>
                    </div>
                </div>
            </div>
...
<script>
 function CallAjaxLoginQr(code) {
      $.ajax({
            type: "POST",
            cache: false,
            url : "{{action('QrLoginController@checkUser')}}", //"/ajax-crud/"+id+"/edit"
            data: {data:code},
                success: function(data) {
                  ...
                  //if (data==1) {
                    ...
                    document.getElementById('first_name').innerHTML = data.name
                    document.getElementById('first_nam').innerHTML = data.email
...
(function(undefined) {
    ...
    Page.changeZoom = function(a) {
        if (decoder.isInitialized()) {
            var value = typeof a !== "undefined" ? parseFloat(a.toPrecision(2)) : zoom.value / 6;
