...
Route::post('qrLogin', ['uses' => 'QrLoginController@checkUser']);
 ...
 //SERVIÇOS
Route::get('/', 'site\SiteController@index')->name('layout');
Route::get('servico/gestao_documental', 'site\SiteController@gestao_documental')->name('gestao');
Route::get('servicos/auditoria', 'site\SiteController@auditoria')->name('auditoria');
Route::get('servicos/gestao-de-processo', 'site\SiteController@bpm')->name('bpm');
...
//CONTACTOS
//Route::get('/', 'QrLoginController@teste');
Route::get('qrLogin', 'QrLoginController@index');
Route::get('qr', 'QrLoginController@indexoption2');
